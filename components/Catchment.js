  ...
  return (
    <div>
      ...
      <figure>
        ...
        <figcaption className='font-bold italic text-xl text-center dark:text-light h-20'>Au-delà des deux zones en surbrillance, merci de me contacter via le formulaire </figcaption>
      </figure>
    </div>
  );
}
