...
const FeaturesCards = ({ data }) => {
  ...
  return (
    <div className="group h-96 w-96 [perspective:1000px] xs:px-3">
  ...
  const Modal = ({ onClose, children }) => {
    return (
      <div className="fixed inset-0 flex">
        ...
        <div className="bg-light p-8 z-10 w-full h-full border-2 border-dark flex justify-center items-center flex-col">
          {/* Contenu de la modale */}
          {children}
          <button
