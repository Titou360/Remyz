  ...
  return (
    <footer className="w-full h-full p-4 flex flex-row items-start justify-around bg-primary gap-10 dark:border-top-solid dark:border-t-[2px] dark:border-light ">
      <div className="flex flex-col w-1/3 gap-4 pt-2">
        <h2 className="text-2xl text-light font-bold">Remyz Aux Verts</h2>
      ...
      <div className="flex flex-col w-1/3 gap-4 pt-2">
        <h2 className="text-2xl text-light font-bold">Liens utiles</h2>
      ...
      <div className="flex flex-col w-1/3 gap-4 pt-2">
        <h2 className="text-2xl text-light font-bold">Horaires d&apos;ouverture</h2>
      </div>
    </footer>
  );
};
