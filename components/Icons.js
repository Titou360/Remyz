...
export const ArrowIcon = ({ className, ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 512 512" className={`w-6 h-6 ${className}`} {...rest}>
    <path d="M140.4 1.4c-21.6 5-36.4 24-36.4 47 0 9.2 1.5 15 6.2 23.9 3.3 6.3 16.7 20 148.7 152.9l31.6 31.8-89.2 89.2c-69.5 69.6-89.7 90.4-91.6 94.3-10 20.1-6.6 44 8.3 57.9 12.5 11.7 31.8 16.1 48.1 11.2 11.9-3.6 13.8-5.3 55.9-47 161.8-160.4 177.1-175.8 179.9-181.5 8.1-15.9 8.2-31.9.4-47.6-2-3.9-26-28.6-112.1-114.7C213.7 42.2 179.2 8.3 175.9 6.5c-10.4-5.6-24.3-7.6-35.5-5.1zm19.2 36.5c2.1 1.6 51.4 50.5 109.6 108.7 84.1 84.3 105.7 106.6 106.3 109.1.5 2.6 0 4.2-2.8 8.5-4.5 6.9-209.2 211.3-213 212.8-9.4 3.4-19-1.6-19.8-10.5-.7-8.7-6.1-2.7 95-104 52.2-52.2 95.6-96.4 96.5-98.2 2-3.9 2.1-9.3.3-13.6-.9-2-37.9-39.5-95.6-96.7-54.9-54.5-95.1-95-96.2-97.2-3.8-7.3-1.5-15.6 5.3-19.8 4.8-2.9 9.7-2.6 14.4.9z" />
  </svg>
);
