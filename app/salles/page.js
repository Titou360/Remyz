      ...
      <section id="sitemap" className="w-full pt-14 flex flex-col items-center bg-light dark:bg-darky">
        ...
        <div className="w-5/6 lg:w-[95%] h-auto mx-auto bg-white rounded-t-lg border border-1 border-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          <div className="m-12 lg:m-4">
            ...
            <div className="mt-12" id="competences">
              ...
              <ol className="list-decimal ml-8 mt-8">
                ...
                <li>
                  ...
                  des plantes.
                  <br />
                  - Amélioration des sols : Techniques pour améliorer la structure et la fertilité du sol, comme l&apos;ajout de compost, de paillis
                  ou d&apos;autres amendements.
                ...
                <li>
                  ...
                  <br />
                  - Planification des espaces verts : Compétence en design pour planifier et concevoir des jardins attrayants et fonctionnels en
                  tenant compte des besoins et des préférences du client.
                  <br />
            ...
            <div className="mt-24">
              <h2 className="text-4xl text-primary font-Spring">Partagez cet article autour de vous !</h2>
